...
namespace StreamWorld.Controllers
{
    public class ContactsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("_id,name,email,subject,message,submissionDate")] Contact contact)
        {
            if (id != contact._id)
            {
                return NotFound();
        ...
        {
            return _context.Contact.Any(e => e._id == id);
        }
    }
}
